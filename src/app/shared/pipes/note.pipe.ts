...
import { NoteColor } from '../../core/interface/interfaces.share';
...
export class NotePipe implements PipeTransform {
  ...
  transform(items: NoteColor[], searchTerm: string): NoteColor[] {
...
function getMatchCount(item: NoteColor, searchTerm: string): number {
  let matchCount = 0;
